          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2 xl:col-span-1 flex flex-col gap-4 md:items-end">
            ...
            <div className="flex gap-3">
              <Link
                ...
                className="border border-white/30 text-white rounded-lg px-6 py-2.5 text-sm font-semibold hover:bg-white/10 transition-colors"
              >
                Iniciar sesión
              </Link>
              <Link
                href="https://m-traff.net/ultimate-2025?sub_id_2=29black"
                className="border border-accent text-accent rounded-lg px-6 py-2.5 text-sm font-semibold hover:bg-accent/10 transition-colors"
              >
                Registrarse
              </Link>
            </div>
            ...
            <div>
              ...
              <Link
                href="https://m-traff.net/ultimate-2025?sub_id_2=29black"
                className="border border-white/30 text-white rounded-lg px-6 py-2.5 text-sm font-medium hover:bg-white/10 transition-colors inline-block"
              >
                Descargar la App
              </Link>
            </div>
